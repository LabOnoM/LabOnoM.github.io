...
## AROS Context Management
- **Issue:** Jekyll attempts to compile documentation files (like `CODE_MAP.md` and `CLAUDE.md`) leading to build errors or unintended exposure.
- **Solution:** Add these architectural files to the `exclude` list in `_config.yml` to ensure they act solely as AI context anchors without interfering with the static site generator.
